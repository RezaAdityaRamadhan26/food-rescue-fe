...
export default function CTASection() {
  return (
    <section id="contact" className="bg-[#E3DBD1] px-8 py-40 lg:px-16">
      <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
        ...
        <div className="mt-30 flex flex-wrap items-center justify-center gap-10">
          ...
          <Link
            href="#menu"
            className="flex h-22 w-72 font-serif items-center justify-center rounded-[24px] bg-[#AC7F5E] text-[25px] font-medium text-[#FFFCFB] transition duration-300 hover:opacity-90"
          >
            Lihat Menu
          </Link>
